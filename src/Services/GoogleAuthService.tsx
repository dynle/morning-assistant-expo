...
export default async function GoogleLogin() {
  try {
    const result = await Google.logInAsync({
        iosClientId: '658921868833-cvcgo0mc31kdgoij31ajuignsljdddts.apps.googleusercontent.com',
        androidClientId: '658921868833-p7hces6eae82gf82oajdbirv6en0946g.apps.googleusercontent.com',
